...
bool Broyden::CalculateNew(complex<double> Vnew[], int it)
{
  it -= LastReset;
  ...
  {  double MaxDiff = 0;
     ...
     if (MaxDiff < Accr) printf("    Broyden: !!! Converged !!!\n");
     return (MaxDiff < Accr);
  }
  else return false;
}
...
void Broyden::ludcmp(complex<double> **a, int n, int *indx)
{
	double d;
	int i,imax,j,k;
	double big,dum,temp;
...
void Broyden::InverseMatrix(complex<double> **a, complex<double> **y, int n)
{
